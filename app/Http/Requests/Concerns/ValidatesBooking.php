...
/**
 * Shared validation for creating a booking, whether it is logged by the room's
 * owner or made by a customer on the public site. The using request decides
 * which room the booking is for.
 */
trait ValidatesBooking
{
    /**
     * Get the room the booking is being made for.
     */
    abstract public function room(): Room;
