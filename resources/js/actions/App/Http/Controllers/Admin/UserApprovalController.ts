...
/**
* @see \App\Http\Controllers\Admin\UserApprovalController::store
 * @see app/Http/Controllers/Admin/UserApprovalController.php:15
 * @route '/admin/users/{user}/approval'
 */
...
/**
* @see \App\Http\Controllers\Admin\UserApprovalController::destroy
 * @see app/Http/Controllers/Admin/UserApprovalController.php:28
 * @route '/admin/users/{user}/approval'
 */
...
const UserApprovalController = { store, destroy }
